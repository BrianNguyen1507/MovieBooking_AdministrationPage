...
<body>
  ...
  <header>
    <nav class="navbar navbar-expand-lg navbar-light bg-white sticky" data-offset="500">
      <div class="container">
        <a href="#" class="navbar-brand">Admin<span class="text-primary"> MovieBookingTickets</span></a>
      ...
      <div class="page-banner home-banner">
        <div class="row align-items-center flex-wrap-reverse h-100">
          <div class="col-md-6 py-5 wow fadeInLeft">
            <h1 class="mb-4">DOASH BOARD FOR ADMIN MOVIE BOOKING TICKETS</h1>
            <p class="text-lg text-grey mb-5">Ignite the most powerfull growth engine you have ever built for your
              company</p>
            <a href="index.php" class="btn btn-primary ">Management</a>
          </div>
  ...
  <div class="page-section">
    ...
    <h1  class="mb-4">MOVIES</h1>
      <a  href="Views/movieAdding.php" class="btn btn-primary btn-split" style="font-weight:bold">NEW <div class="fab"><span class="mai-play"></span>
        </div></a></a>
      <?php
      include ("modules/fetch/fetchingMovies.php");
      ?>
    </div> <!-- .container -->
  </div> <!-- .page-section -->
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-6 py-3 pr-lg-5 wow fadeInUp">
            <h2 class="title-section">Admin to Improve Brand <br> Visibility</h2>
            <div class="divider"></div>
            ...
            <ul class="theme-list theme-list-light text-white">
              <li>
                <div class="h5">Admin Content Strategy</div>
    ...
    <div class="container">
      <div class="row mb-5">
        <div class="col-lg-3 py-3">
          <h3>AdminGram</h3>
          <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Libero amet, repellendus eius blanditiis in
            iusto
            eligendi iure.</p>
        ...
        <div class="col-lg-3 py-3">
          ...
          <a href="#" class="footer-link">Admingram@temporary.com</a>
        </div>
        <div class="col-lg-3 py-3">
          <h5>Newsletter</h5>
